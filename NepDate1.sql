...
IF EXISTS (SELECT * FROM NepDate WHERE [6] = 30 AND BS = 2083) 
BEGIN
	DELETE FROM NepDate WHERE BS = 2083
	INSERT INTO NepDate VALUES 
	('2083','14 APR 2026','13 APR 2027', '25/26', 31,31,32,31,31,31,30,29,30,29,30,30, NULL)
	DELETE FROM DATEMITI WHERE MITI LIKE '%2083'
	EXEC nsp_PopulateDateMiti 2083
END