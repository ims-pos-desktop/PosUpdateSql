...
SELECT @AltRateByDiscount = IIF(EnableBatch = 0 OR EnableFlatSRateInAltUnit=1,0,1) FROM SETTING
...
(
    ...
    CASE WHEN @AltRateByDiscount = 1 OR A.RATE_B = 0 THEN M.RATE_B  ELSE A.RATE_B/A.CONFACTOR END RATE_B,
    A.SRATE_DISCOUNT, A.WSRATE_DISCOUNT
    FROM MENUITEM M
