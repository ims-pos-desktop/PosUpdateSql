IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'PaymentModes' AND COLUMN_NAME = 'IncludeInExcessShortCalculation')
ALTER TABLE PaymentModes ADD IncludeInExcessShortCalculation BIT NOT NULL DEFAULT (0) WITH VALUES
...
IF EXISTS(SELECT * FROM SETTING WHERE EnablePreBill = 1)
UPDATE SETTING SET EnablePreBill = 0
