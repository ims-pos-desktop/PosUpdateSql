...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'UserProfiles' AND COLUMN_NAME = 'TERMINAL')
ALTER TABLE UserProfiles ADD TERMINAL CHAR(3) NULL, CONSTRAINT FK_UserProfiles_Terminal FOREIGN KEY (TERMINAL) REFERENCES SALESTERMINAL(INITIAL)