...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'abbProd_TaxDetails' AND COLUMN_NAME = 'taxId')
ALTER TABLE abbProd_TaxDetails ADD taxId INT

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'abbProd_TaxDetails' AND COLUMN_NAME = 'taxRate')
ALTER TABLE abbProd_TaxDetails ADD taxRate DECIMAL(5,2)

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'abbProd_TaxDetails' AND COLUMN_NAME = 'isCompoundTax')
ALTER TABLE abbProd_TaxDetails ADD isCompoundTax BIT

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'abbProd_TaxDetails' AND COLUMN_NAME = 'taxOrder')
ALTER TABLE abbProd_TaxDetails ADD taxOrder INT

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'trnProd_TaxDetails' AND COLUMN_NAME = 'taxId')
ALTER TABLE trnProd_TaxDetails ADD taxId INT

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'trnProd_TaxDetails' AND COLUMN_NAME = 'taxRate')
ALTER TABLE trnProd_TaxDetails ADD taxRate DECIMAL(5,2) 

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'trnProd_TaxDetails' AND COLUMN_NAME = 'isCompoundTax')
ALTER TABLE trnProd_TaxDetails ADD isCompoundTax BIT

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'trnProd_TaxDetails' AND COLUMN_NAME = 'taxOrder')
ALTER TABLE trnProd_TaxDetails ADD taxOrder INT