...
--SET @DATE1 = '2024-07-16'; SET @DATE2 = '2027-04-15'; SET @FYID = '81/82';SET @OPT_REPORTTYPE = 2; 
...
INNER JOIN RMD_TRNMAIN_FN(0, @FYID) TM ON A.VCHRNO = TM.VCHRNO AND A.VoucherType = TM.VoucherType
INNER JOIN MENUITEM B ON A.MCODE = B.MCODE  
WHERE TM.TRNDATE <= @DATE2 AND A.WAREHOUSE LIKE @WAREHOUSE AND A.DIVISION LIKE @DIVISION AND ISNULL(B.MCAT,'') LIKE @MCAT AND B.MGROUP LIKE @MGROUP 
