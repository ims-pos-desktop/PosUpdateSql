...
--SELECT @DATE1='2026-01-15 00:00:00',@DATE2='2026-02-12', @DIV = '%', @V1  = 'SI', @V2 ='CN', @REPMODE = 1
...
IF @REPMODE = 0
	BEGIN
		...
		(
			...
			CASE WHEN TM.VCHRNO LIKE 'RE%' THEN LEFT(Refbill, CHARINDEX('-', Refbill) - 1)  ELSE VNUM END XVNO 
