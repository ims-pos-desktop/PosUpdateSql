...
BEGIN
	...
	(B.TAXABLE + B.NONTAXABLE) SALESAMOUNT, IIF(A.VMODE <> 2 , B.NONTAXABLE , 0) AS NONTAXABLE,
	IIF(A.VMODE = 2 , B.NONTAXABLE , 0) EXPORTSALES , B.TAXABLE, B.VAT VATAMNT, A.REMARKS,
