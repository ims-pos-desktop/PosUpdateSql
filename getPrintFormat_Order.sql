...
AS
--SELECT @VCHRNO = 'SO10-MMD-81/82', @DIVISION = 'MMD', @PHISCALID = '81/82'
BEGIN
...
, MT.DESCA, B.BILLTOTEL billpan, ISNULL(P.INDDISCOUNTRATE,0) INDDISRATE, M.DCRATE * 100 dcrate, P.ALTUNIT,P.INDDISCOUNTRATE, CONVERT(INT, P.SNO) SN,0 tender, 0 change
, FORMAT(SUM(IIF(MT.VAT = 0, 1,1.13) * P.INDDISCOUNT) OVER () ,'N2') dcamnt
...
LEFT JOIN RMD_Order_AdditionalDetail RO ON P.VCHRNO =RO.VCHRNO AND P.MCODE = RO.MCODE AND P.SNO = RO.SNO
