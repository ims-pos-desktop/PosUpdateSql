...
SELECT MCODE,BCODE, BCODE BARCODE, EDATE,
...
UNION ALL
SELECT B.MCODE,B.BCODE, BD.BARCODE, B.EDATE, BD.COLOR, BD.SIZE, BD.MAKE, BD.GENDER, BD.ORIGIN, BD.FIT, BD.SEASON, BD.MEASUREMENT
