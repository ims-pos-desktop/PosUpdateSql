...
IF NOT EXISTS (SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SALESTERMINAL' AND COLUMN_NAME = 'FonepayUsername')
ALTER TABLE SALESTERMINAL ADD FonepayUsername VARCHAR(50)

IF NOT EXISTS (SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SALESTERMINAL' AND COLUMN_NAME = 'FonepayPassword')
ALTER TABLE SALESTERMINAL ADD FonepayPassword VARCHAR(50)